...
from ..models.schemas import SentenceItem

router = APIRouter()

DATA_PATH = Path(__file__).parent.parent.parent.parent / "data" / "llm_sentences.json"
...
def get_sentences(
    asin:      str,
    category:  Optional[str] = Query(None, description="속성 필터"),
