 ...
 * 리뷰 패널    : 키워드 클릭 시 /api/sum-map/search 호출 (전체 리뷰 검색).
  ...
  return (
    <section style={{ marginBottom: 28 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
        ...
        <div style={{ fontSize: 22, color: 'var(--text-muted)', display: 'flex', alignItems: 'center', gap: 6 }}>
          <span style={{ color: 'var(--accent-red)',   fontWeight: 700, fontSize: 24 }}>■</span>부정 키워드
          &nbsp;
          <span style={{ color: 'var(--accent-green)', fontWeight: 700, fontSize: 24 }}>■</span>긍정 키워드
        </div>
      </div>
