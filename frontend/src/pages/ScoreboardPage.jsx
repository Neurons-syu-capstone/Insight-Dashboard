...
import SentencePanel from "../components/scoreboard/SentencePanel"
    ...
    <div style={{ background: "#fff", borderBottom: "1px solid #e5e7eb", padding: "0 32px" }}>
      <button
        ...
        style={{
          ...
          fontSize: 13, color: "#6b7280", fontWeight: 500, width: "100%", textAlign: "left",
        }}
      >
        <span style={{
          display: "inline-flex", alignItems: "center", justifyContent: "center",
          width: 18, height: 18, borderRadius: 99,
          background: "#6366f1", color: "#fff", fontSize: 11, fontWeight: 700, flexShrink: 0,
        }}>i</span>
        점수 계산 방식 및 기준 안내
      ...
      {open && (
        <div style={{ padding: "0 0 16px 26px", fontSize: 13, color: "#374151", lineHeight: 1.8 }}>
...
export default function ScoreboardPage() {
  ...
  return (
    <div style={{ height: "calc(100vh - 52px)", display: "flex", flexDirection: "column", background: "#f8fafc", fontFamily: "'IBM Plex Sans KR', sans-serif" }}>
        ...
        <aside style={{
          ...
          <div style={{ padding: "16px 16px 0", borderBottom: "1px solid #f3f4f6" }}>
            <input
              ...
              style={inputStyle}
            />
            <select value={selectedBrand} onChange={e => setSelectedBrand(e.target.value)} style={{ ...inputStyle, marginTop: 8 }}>
            ...
            {products.map(p => (
              <div
                ...
                style={{
                  ...
                  borderLeft: selectedProduct?.asin === p.asin ? "3px solid #6366f1" : "3px solid transparent",
                  transition: "all 0.1s",
                }}
              >
                <div style={{ fontSize: 12, color: "#9ca3af", marginBottom: 2 }}>
                  <span style={{
                    background: BRAND_COLORS[p.brand] || "#e5e7eb", color: "#fff",
            ...
            <>
              <div style={{ marginBottom: 24 }}>
                <div style={{ fontSize: 12, color: "#9ca3af", marginBottom: 4 }}>
                  <span style={{
                    background: BRAND_COLORS[selectedProduct.brand] || "#e5e7eb", color: "#fff",
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginBottom: 24 }}>
                <div style={cardStyle}>
                  ...
                  <RadarChart scores={selectedProduct.scores} brandColor={BRAND_COLORS[selectedProduct.brand] || "#6366f1"} />
                </div>
                <div style={cardStyle}>
              ...
              <SentencePanel asin={selectedProduct.asin} category={selectedCat} />
            </>
          )}
        </main>
      </div>
...
const cardTitleStyle = {
  margin: "0 0 16px", fontSize: 14, fontWeight: 700, color: "#374151",
}
